# Star Tribune - Minnesota Poll 2017: Healthcare
...
1. Get code and enter project: `git clone https://github.com/striblab/20170502-mnpollv3-healthcare.git && cd 20170502-mnpollv3-healthcare.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170502-mnpollv3-healthcare/ && rsync -rav ./ ../20170502-mnpollv3-healthcare/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
